 	...
 	$.ajax({
		   ...
		   success: function(data){
			      $.each(data.cart, function(i, value) {
			           ...
			           '<td><input name="count"  type="text" value="1" class="input_text" size="2" style="text-align:center;width:60px;" onchange="cacul('+value.gunitprice+'*this.value,'+i+')"/></td>'+
			           '<td width="120" style="color:red;font-weight:bold;">&yen;<span id="'+i+'">'+value.gunitprice+'</span></td>'+
...
<div class="navbar">
  <div class="navbar-inner">
    ...
    <ul class="nav">  
	<li class="active"><a href="#" rel="nofollow"><i class=" icon-shopping-cart"></i> 我的购物车</a></li>
