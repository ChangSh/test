			...
			<form id="form">
			 <input id="imgname" type="hidden" name="img_src">
				<table class="table2 cus_info work" id ="tableinfo" style="margin:0 auto">
					<tr>
						<td style="width:70px;"><label for="" class="lb" style="width:70px;"><span style = "color: Red">*</span><span>商品名：</span></label></td>
						<td ><input type="text" name="gname" /></td>
					</tr>
					<tr>
						<td style="width:70px;"><label for="" class="lb" style="width:70px;"><span style = "color: Red">*</span><span>分类：</span></label></td>
						<td ><f:select name="gtype"
						sectionname="分类"  value=""></f:select></td>
					</tr>
					<tr>
						<td style="width:70px;"><label for="" class="lb" style="width:70px;"><span style = "color: Red">*</span><span>单价：</span></label></td>
						<td><input type="text" name="gunitprice" /></td>
					</tr>
					<tr>
						<td style="width:70px;"><label for="" class="lb" style="width:70px;"><span style = "color: Red">*</span><span>简介：</span></label></td>
						<td><input type="text" name="gbriefintro" /></td>
					</tr>
					<tr>
						<td style="width:70px;"><label for="" class="lb" style="width:70px;"><span style = "color: Red">*</span><span>详细：</span></label></td>
						<td><input type="text" name="gdetailintro" /></td>
					</tr>
						<tr>
						<td style="width:70px;"><label for="" class="lb" style="width:70px;"><span style = "color: Red">*</span><span>规格：</span></label></td>
					...
					<tr>
						...
						<tr>
						<td><span style = "color: Red">*</span>上传图片：  <!--dom结构部分-->
