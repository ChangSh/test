package com.test.edusys.college.service;
...
public class CollegeMajorService extends BaseService {
	...
	public Map<String, Object> queryCollegePage(NewPager page) {
		Criteria cri = getCriteriaFromPage(page);
		List<College> list = dao.query(College.class, cri, page);
		page.setRecordCount(dao.count(College.class, cri));
	...
	public College fetchCollege(String id) {
		return dao.fetch(College.class, id);
	}
	...
	public int updateIgnoreNullCollege(College record) {
	...
	public int deleteCollege(String id) {
		return dao.delete(College.class, id);
	}
