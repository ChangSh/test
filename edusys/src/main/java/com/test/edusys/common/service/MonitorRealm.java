package com.test.edusys.common.service;
...
public class MonitorRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(
		...
		Role role = dao.fetch(Role.class,Cnd.where("id","in"," SELECT roleid FROM t_system_user_role WHERE userid="+principal.getId()+" "));
		if (role!=null){
			authorizes = dao.query(Authorize.class,Cnd.where("id","in"," SELECT auth_id from t_system_role_authorize WHERE role_id ="+role.getId()+"  "));
