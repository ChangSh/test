 ...
 */
package com.test.edusys.common.utils.reflection;
...
public class ReflectionUtils {
	 ...
	 * 判断类的注释值
	 */
	public static String getShowLogTablename(final Class clazz) {
		...
		for (Annotation cAnnotation : classAnnotation) {
			if (ShowLogTablename.class == cAnnotation.annotationType()) {
				ShowLogTablename xmlElement = (ShowLogTablename) cAnnotation;
