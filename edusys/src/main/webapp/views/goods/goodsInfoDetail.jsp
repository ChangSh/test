		...
		<div class="tit_down">
			<form id="form">
				<table width="100%" class="table2">
					<tr>
						<td width="15%"><label for="" class="lb">商品名称：</label></td>
						<td width="30%">${ob.gname}</td>
						
					</tr>
					<tr>
						<td style="width:70px;"><label for="" class="lb">分类：</label></td>
					     <td width="30%" id="gtype"></td>
					</tr>
					<tr>
					<td width="15%"><label for="" class="lb">商品单价：</label></td>
					...
					<tr>
						<td><label for="" class="lb" >规格：</label></td>
						<td><p>${ob.gsize}</p></td>
					</tr>
					<tr>
