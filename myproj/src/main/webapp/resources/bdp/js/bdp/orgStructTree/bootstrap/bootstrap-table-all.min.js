...
* 
* 添加了beforeSearch方法，用于手动查询时调用，设置页码样式和内部页码参数为1，
* 解决查询时页码不为1且查询结果页码不对问题。调用method方式一样 没有参数。 
* 源代码：o.prototype.beforeSearch=function(){this.$pagination.find(".page-number").first().addClass("active").siblings().removeClass("active");this.options.pageNumber=1;}
*/
