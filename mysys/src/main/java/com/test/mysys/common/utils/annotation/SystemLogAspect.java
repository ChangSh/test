...
public  class SystemLogAspect {   
    ...
    //Service层切点  
    @Pointcut("@annotation(com.troila.kxe.common.utils.annotation.SystemServiceLog)")  
     public  void serviceAspect() {  
    }  
  
    //Controller层切点  
    @Pointcut("@annotation(com.troila.kxe.common.utils.annotation.SystemControllerLog)")  
     ...
     public  void doBefore(JoinPoint joinPoint) {  
        ...
        String ip = request.getRemoteAddr();  
         try {  
            ...
            log.setCreateDate(TimeUtil.getStringDate());  
            //保存数据库  
