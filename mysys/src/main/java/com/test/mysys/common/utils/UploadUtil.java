...
public class UploadUtil {
	...
	public static String uploadFile(HttpServletRequest request, HttpServletResponse response, String ctxPath)
			throws Exception {
		String responseStr = "";
	 ...
	 * @throws Exception
	 */
	public static String uploadFileReturnFileName(HttpServletRequest request, HttpServletResponse response,
