package com.test.mysys.input.controller;
...
import com.test.mysys.input.service.InputService;
...
public class InputController {
	...
	@ResponseBody
	public Map listDetail(HttpServletRequest request,
