...
import com.test.mysys.system.model.RoleAuthorize;
import com.test.mysys.system.model.User;
import com.test.mysys.system.model.UserRole;
import com.test.mysys.system.service.AuthorizeService;
import com.test.mysys.system.service.RoleService;
import com.test.mysys.system.service.UserRoleService;
...
public class RoleController {
	...
	public Map<String, Object> ajax_userlist(HttpServletRequest request,
		...
		Map<String, Object> map = userService.queryPage(pager);
	...
	public boolean havaRole(HttpServletRequest request,
		...
		List<Role> list = service.query(Cnd.where("rolename", "=", rolename));
		if (!list.isEmpty())
			return false;
	...
	public String userRole(HttpServletRequest request, @RequestParam(value = "userid") long userid) {
	...
	public String inputRoleMenu(HttpServletRequest request, @RequestParam(value = "id", defaultValue = "0") int id) {
		request.setAttribute("ob", service.fetch(id));
	...
	@ResponseBody
	public String saveRoleUser(HttpServletRequest request, @RequestParam(value = "id", defaultValue = "0") int id,
	...
	@ResponseBody
	public String saveMenu(HttpServletRequest request, @RequestParam(value = "id", defaultValue = "0") int id,
	...
	@ResponseBody
	public String saveAuthorize(HttpServletRequest request, @RequestParam(value = "id", defaultValue = "0") int id,
