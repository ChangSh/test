...
import com.test.mysys.common.Const;
...
//		return "views/system/input-user";	
	...
	public boolean checkRepeakByLoginname(@RequestParam(value="loginname") String loginname ,
		...
		List list=service.query(Cnd.where("loginname", "=",loginname ));
		if (!list.isEmpty())
			return false;
	...
	public String login(@RequestParam(value="loginname") String ln,
		...
		if((currentUser.isAuthenticated())&&(currentUser.hasRole("超级管理员"))){
...
//		    }
	...
	//*************************************************************************
		...
		@ResponseBody
		public String userBatchImport(HttpServletRequest request, HttpServletResponse response,String type,String typess) throws Exception {
		...
		@ResponseBody
		public Map updatepsw(HttpServletRequest request,String rpsw){
