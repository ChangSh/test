...
function addHoverDom(treeId, treeNode) {
	...
	if (btn) btn.bind("click", function(){//新增时
		$("#inputPage").load('${ctx}/views/system/input-menu.jsp?pid='+treeNode.id);
	});
...
<ul id="menuTree" class="ztree" style="float: left;width:300px;"></ul>
<div id="inputPage" style="float: left; width: 500px;margin:20px">
</div>
</body>	
</html>