...
<link href="<%=contextPath%>/resources/bdp/bootstrap/bootstrapvalidator/src/css/bootstrapValidator.css" rel="stylesheet" media="screen">
<script src="<%=contextPath%>/resources/bdp/bootstrap/bootstrapvalidator/src/js/bootstrapValidator.js"></script>
<script src="<%=contextPath%>/resources/bdp/bootstrap/bootstrapvalidator/src/js/language/zh_CN.js"></script>